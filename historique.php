...
<head>
  ...
  <title>Historique - Sending mails</title>
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Afficher l'historique'</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
...
$id=$_SESSION['id'];
$query = "SELECT * FROM history WHERE iduser= $id";
   ...
   echo "
          <div class='card'>
            ...
            <div class='card-body'>
              ...
              <div class='card-header'>De: ".$row["fromm"]."</div>
              <div class='card-header'>A: ".$row["too"]."</div>
              <h5 class='card-title'>Objet: ".$row["objet"]."</h5>
              ".$row["message"]."
            </div>
