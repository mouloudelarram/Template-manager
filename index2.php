    ...
    <div class="container-fluid">
        <div class="row cb-slideshow-text-container ">
            <div class="tm-content col-xl-6 col-sm-8 col-xs-8 ml-auto section">
                ...
                <P class="mb-5">connecter vous pour beneficier d'un envoyeur et d'un gestionnaire de template</P>

                <form action="pages-login.php" method="get" class="subscribe-form">
