...
<head>
  ...
  <title>Dashboard - Sending mails</title>
          ...
          <div class="row">
            ...
            <div class="col-xxl-4 col-md-6"  >
              ...
              <div class="card info-card sales-card" >
                ...
                <div class="card-body">
                  <h5 class="card-title">E-mail <span>| Today</span></h5>
            ...
            <!-- Revenue Card -->
            <div class="col-xxl-4 col-md-6 cardcust">
              <a href="forms-elements.php">
              <div class="card info-card revenue-card">
                ...
                <div class="card-body">
                  <h5 class="card-title">Templates <span>| This Month</span></h5>
            ...
            <!-- Customers Card -->
            <div class="col-xxl-4 col-xl-12 cardcust" >
              ...
              <div class="card info-card customers-card">
                ...
                <div class="card-body">
                  <h5 class="card-title">Historique <span>| This Year</span></h5>
